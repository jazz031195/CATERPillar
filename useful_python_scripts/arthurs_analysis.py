...
sys.path.append('/home/localadmin/Documents/MCDS/Permeable_MCDS')
    ...
    for compartment in compartments:
        ...
        for i, file in enumerate(DWI_files):
            ...
            if "iso" in file:
                ...
                sequence = "iso"
                filename = DWI_filenames[i].split("iso")[0][:-1] 
            else:
